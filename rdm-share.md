...
📧 Do not hesitate to consult any aspect of the data sharing with OS support.
...
Metadata help others find and reuse the data. The following is usually part of the repository submission process:
...
README file is a manual for the dataset. It is uploaded to the repository alongside the dataset. You can use a template provided by the collective of Czech Data Stewards on Github.
