...
<details markdown="1">
  ...
  Platbu bude se zástupcem vydavatele řešit finanční manažer projektu.
...
- Institucionální repozitáře: [Masarykova univerzita](https://is.muni.cz/repozitar/), [Univerzita Karlova](https://dspace.cuni.cz/), [Psychologický ústav AV ČR](https://asep.lib.cas.cz/arl-cav/)
...
- Publikace prokazatelně vznikla v rámci projektu – odeslání do recenzního řízení po nástupu na projekt.
...
- Publikace splňuje kritéria pro odvod do RIV jako očekávaný druh výsledku a bude za instituci odvedena.
- Má přiděleno DOI.
